...
// path.join creates a path for our folders by providing the bits and it constructs the url
// different OS's / machines have different methods of writing paths, so path.join is good practice
// compared to manually writing out the string
// __dirname is a global variable that holes the full path to the current directory
